...
class Log{
    public static function Add($id_usuario, $usuario, $rol, $entidad, $operacion, $id_entidad, $datos_operacion, $datos_resultado_operacion){
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO logs (id_usuario, usuario, rol, entidad, operacion, id_entidad, datos_operacion, datos_resultado_operacion, fecha_hora) VALUES (:id_usuario, :usuario, :rol, :entidad, :operacion, :id_entidad, :datos_operacion, :datos_resultado_operacion, :fecha_hora)");
